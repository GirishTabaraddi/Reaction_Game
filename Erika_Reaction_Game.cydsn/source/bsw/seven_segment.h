...
*/
 enum eSeven{
  Seven_Segment_Left = 1,  /**< Select the Left Seven Segment Display SA1. */
  Seven_Segment_Right = 0 /**< Select the Left Seven Segment Display SB1. */
} ;
typedef enum eSeven mySeven_t;
