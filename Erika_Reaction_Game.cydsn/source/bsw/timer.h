...
/* API functions                                                             */
/*****************************************************************************/
volatile uint16_t event_timeout;
/**
 * TIME_SetAlarm
 * @param timeout_value: takes the value between 1s and 3s and sets the delay
 * @return RC_SUCCESS if no error
 */
RC_t TIMER_SetAlarm(uint16_t timeout_value);

boolean_t TIMER_CheckTimeoutValue();
#endif /* TIMER_H */
