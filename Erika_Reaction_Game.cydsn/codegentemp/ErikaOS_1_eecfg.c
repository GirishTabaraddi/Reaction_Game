 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_2[TASK_2_STACK_SIZE];	/* Task 2 (task_background) */
    #endif
    #if ((2 == 2) && (EE_MAX_TASK > 2))
    #define TASK_3_STACK_SIZE 4000/4 // size = 4000 bytes
    int EE_cortex_mx_stack_3[TASK_3_STACK_SIZE];	/* Task 3 (task_control) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 3))
    #define TASK_4_STACK_SIZE 0/4 // size = 0 bytes
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (task_timer) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 4))
    #define TASK_5_STACK_SIZE 0/4 // size = 0 bytes
    int EE_cortex_mx_stack_5[TASK_5_STACK_SIZE];	/* Task 5 (task_fader) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 5))
    #define TASK_6_STACK_SIZE 400/4 // size = 400 bytes
    int EE_cortex_mx_stack_6[TASK_6_STACK_SIZE];	/* Task 6 (task_glower) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 6))
    #define TASK_7_STACK_SIZE 400/4 // size = 400 bytes
    int EE_cortex_mx_stack_7[TASK_7_STACK_SIZE];	/* Task 7 (task_glower) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_2_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_2[(TASK_2_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}	/* task_background*/
        #endif
        #ifdef TASK_3_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_3[(TASK_3_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])} 	/* task_control*/
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* task_timer*/
        #endif
        #ifdef TASK_5_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_5[(TASK_5_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* task_fader*/
        #endif
        #ifdef TASK_6_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_6[(TASK_6_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* task_glower*/
        #endif
        #ifdef TASK_7_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_7[(TASK_7_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* task_glower*/
        #endif
        #ifdef TASK_8_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 3
    DeclareTask(task_timer);
    #endif
    #if EE_MAX_TASK > 4
    DeclareTask(task_fader);
    #endif
    #if EE_MAX_TASK > 5
    DeclareTask(task_glower);
    #endif
    #if EE_MAX_TASK > 6
    DeclareTask(task_glower);
    #endif
    ...
    #endif
    #if EE_MAX_TASK > 2
        ,&EE_oo_thread_stub      /* thread task_control */
    #endif
    #if EE_MAX_TASK > 3
        ,&EE_oo_thread_stub      /* thread task_timer */
    #endif
    #if EE_MAX_TASK > 4
        ,&EE_oo_thread_stub      /* thread task_fader */
    #endif
    #if EE_MAX_TASK > 5
        ,&EE_oo_thread_stub      /* thread task_glower */
    #endif
    #if EE_MAX_TASK > 6
        ,&EE_oo_thread_stub      /* thread task_glower */
    #endif
 ...
 **************************************************************************/
    ...
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        #if EE_MAX_ALARM > 0
        {0, alarm_timer_tick, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 1
        ,{0, alarm_wait1s, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 2
        ,{0, alarm_wait3s, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 3
        ,{0, alarm_fader, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 4
        ,{0, alarm_glower, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 5
        ,{0, Alarm_6, EE_ALARM }
        #endif
