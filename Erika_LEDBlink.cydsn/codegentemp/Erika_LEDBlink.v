// ======================================================================
// Erika_LEDBlink.v generated from TopDesign.cysch
// 12/01/2022 at 10:14
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("94815266-bba4-40bb-b9cd-afcaf911112d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0fb3def6-e393-4bc2-83aa-6272bddae54f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4b36eec5-3cec-4e08-8c27-740eecb7b42c"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    assign Net_84 = Net_79 | Net_80 | Net_82 | Net_83;
	...
	cy_psoc3_pins_v1_10
		#(.id("44ab464f-dec5-4d01-be1f-e2468d414321"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fa3028aa-14ff-4310-a34e-182d6e226966"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
