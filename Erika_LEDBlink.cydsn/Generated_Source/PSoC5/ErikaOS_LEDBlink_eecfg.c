 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_3[TASK_3_STACK_SIZE];	/* Task 3 (task_ledBlink) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_3_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_3[(TASK_3_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])} 	/* task_ledBlink*/
        #endif
        #ifdef TASK_4_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 2
        ,&EE_oo_thread_stub      /* thread task_ledBlink */
    #endif
    #if EE_MAX_TASK > 3
...
#define MAX_PRIORITY 0x80U
    ...
    EE_TYPEPRIO EE_rq_link[EE_MAX_TASK] =
        { 
        #include "ErikaOS_LEDBlink_task_priorities.inc"
            #if EE_MAX_TASK > 0
            TSK1_PRI
            #endif
            #if EE_MAX_TASK > 1
 ...
 **************************************************************************/
    ...
    */
    EE_TYPEBOOL EE_resource_locked[EE_MAX_RESOURCE] =
        ...
        #include "ErikaOS_LEDBlink_resource_priorities.inc"
